...
---
This file is derived from the official Point Transformer V3 release and remains
under its original MIT license (Copyright (c) 2023 Pointcept). See
THIRD_PARTY_NOTICES.md. Modifications for InterTreeSeg are distributed under the
